...
rustPlatform.buildRustPackage {
  ...
  src = fetchFromGitHub {
    ...
    postFetch = ''
      substituteInPlace $out/Cargo.toml --replace 'libcosmic?branch=master' '/libcosmic'
      substituteInPlace $out/Cargo.lock --replace 'libcosmic?branch=master?rev=' '/libcosmic?rev='
    '';
  };
